...
describe('Booking Controller', () => {
  ...
  describe('getBooking', () => {
    it('should return the booking data with status 200 if found', async () => {
      ...
      await getBooking(mockRequest as AuthenticatedRequest<{}, EventBookingParams>, mockResponse as Response);
  ...
  describe('cancelBooking', () => {
    it('should cancel the booking and return status 204', async () => {
      ...
      await cancelBooking(mockRequest as AuthenticatedRequest<{}, EventBookingParams>, mockResponse as Response);
