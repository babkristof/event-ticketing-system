...
describe('Event Route Validations', () => {
  ...
  describe('POST /api/events', () => {
    ...
    const invalidEventData = [
      {
        desc: 'missing name',
        data: { description: 'Desc', date: '2024-11-16T14:15', venue: 'Venue', totalTickets: 100 }
      },
      {
        desc: 'missing description',
        data: { name: 'Event', date: '2024-11-16T14:15', venue: 'Venue', totalTickets: 100 }
      },
      {
        desc: 'invalid date',
        data: { name: 'Event', description: 'Desc', date: 'invalid-date', venue: 'Venue', totalTickets: 100 }
      },
      {
        desc: 'negative tickets',
        data: { name: 'Event', description: 'Desc', date: '2024-11-16T14:15', venue: 'Venue', totalTickets: -5 }
      }
    ];
