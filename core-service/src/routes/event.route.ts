...
eventRoutes.post(
  '/',
  [authMiddleware, roleMiddleware(Role.ADMIN)],
  validateBody(createEventSchema),
  errorHandler(eventController.createEvent)
);
...
eventRoutes.get(
  ...
  errorHandler(eventController.getEvent)
);
eventRoutes.delete(
  '/:eventId',
  [authMiddleware, roleMiddleware(Role.ADMIN)],
  validateParams(getEventSchema),
  errorHandler(eventController.deleteEvent)
);
eventRoutes.patch(
  '/:eventId',
  [authMiddleware, roleMiddleware(Role.ADMIN)],
  ...
  validateParams(getEventSchema),
  errorHandler(eventController.updateEvent)
);
